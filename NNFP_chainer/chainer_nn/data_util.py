...
def csv_to_dict(fname, culnums, colnames, coltypes, header=False, **kwargs):
...
def remove_duplicates(values, key_lambda):
	...
	seen = set()
	for value in values:
		#If value has not been encountered yet, add it to both ist and set.
		cor_key = key_lambda(value)
